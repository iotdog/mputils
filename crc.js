...
function CRC32(data) {
  ...
  // let table1 = CRC32TablePredefined
  // let equal = true
  // for (let i=0; i<table.length; i++) {
  //   if (table[i] != table1[i]) {
  //     equal = false
  //     console.log('table ', i, ' is not equal to table1 ', i)
  //     break
  //   }
  // }
  // if (equal) {
  //   console.log('equal')
  // }
  let table = CRC32TablePredefined
  let crc = 0xffffffff
